...
export const useStageStore = defineStore("stage", {
  ...
  actions: {
    ...
    async getStages() {
      await axios.get("/api/stages").then((response) => {
    ...
    /* get all stages */
    async getStagesAll() {
      await axios.get("/api/stages/all").then((response) => {
    ...
    /* get stage */
    async getStage(id) {
      await axios.get("/api/stages/" + id).then((response) => {
    ...
    async deleteStage(id) {
      await axios.delete("/api/stages/" + id).then((response) => {
        this.messagesStore = response.data;
        this.getStages();
      });
    },
